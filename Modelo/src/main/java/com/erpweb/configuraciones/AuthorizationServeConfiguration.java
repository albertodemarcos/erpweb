...
public class AuthorizationServeConfiguration extends AuthorizationServerConfigurerAdapter {
	...
	public void configure(AuthorizationServerEndpointsConfigurer endpoints) throws Exception {
		...
		tokenEnhancerChain.setTokenEnhancers(Arrays.asList(informacionAdiccionalToken, accessTokenConverter()));
